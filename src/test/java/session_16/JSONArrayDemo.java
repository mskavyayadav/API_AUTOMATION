...
public class JSONArrayDemo {
 ...
 "firstName":"Mohit",
   ...
   "salary": 10000.56,
		...
		user1.put("firstName","Mohit");
		user1.put("lastName","Yadav");
		user1.put("age",31);
		user1.put("salary",10000.56);
		
		JSONObject user2 = new JSONObject();
		user2.put("firstName","Kavya");
		user2.put("lastName","Yadav");
		user2.put("age",2);
		user2.put("salary",10000.56);
		
		JSONObject user3 = new JSONObject();
		user3.put("firstName","Swati");
		user3.put("lastName","Agarwal");
		user3.put("age",28);
